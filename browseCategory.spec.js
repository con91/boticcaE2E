...
describe('Browse page - Categories', function () {
	...
	it('should have Earrings sub-category Ear Jackets', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Ear Jackets');
	...
	it('should have Hats sub-category Facinators', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Fascinators');
	...
	it('should have Hats sub-category Small Hair Accessories', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Small Hair Accessories');
	...
	it('should have Hats sub-category Straw Hats', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Straw Hats');
	...
	it('should have Hats sub-category Headbands', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Headbands');
	...
	it('should have Hats sub-category Other Hats', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Other Hats');
	...
	it('should have Hats sub-category Caps', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Caps');
	...
	it('should have Hats sub-category Pillbox Hats', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Pillbox Hats');
	...
	it('should have Hats sub-category Fedoras', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Fedoras');
	...
	it('should have Hats sub-category Beanies', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Beanies');
	...
	it('should have Hats sub-category Berets', function () {
		...
		expect(browsePage.selectedFacets.getText()).toContain('/ Berets');
		expect(browsePage.renfinedBy.getText()).toContain('Berets');
	});

	it('should have Hats sub-category Turbans', function () {
		browsePage.row9.click();
		app.halt();
		expect(browser.getCurrentUrl()).toContain('/browse/#/Hats/Turbans');
		expect(browsePage.selectedFacets.getText()).toContain('/ Turbans');
		expect(browsePage.renfinedBy.getText()).toContain('Turbans');
	});
